...
import "../../Components/Men/MenPage.css";
...
function MoreProduct() {
  return (
    <div className="moreproduct-container">
      <div className="moreproduct-box1">
        <div className="moreproduct-heading">
          <p>MORE PRODUCTD ON :-</p>
        </div>
        <div className="moreproduct-buttons">
          <button>FROK</button>
          <button>GREEN</button>
      ...
      <div className="moreproduct-box2">
        <div className="moreproduct-slider-heading">
          <p>SOME MORE LIKE THIS</p>
        </div>

        {/* <div className="moreproduct-slider"> */}
